...
<div class="Navigation">
    <div class="SpielerInfoContainer">
        <div class="Avatarbild">
            ...
            <img class="LvLPlakette" src="/Bilder/LvL_Plakette.png" />
            <div class="LvL">
            ...
            <div class="Bildupload">
                <form id="inputform" action="./funktionen.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input id="inputfile" class="Angepasster-Input" type="file" name="bildhochladen" /><br />
                    <input id="subbtn" class="Avatarbutton" type="image" src="/Bilder/Haken.png" />
                    <img for="loeschen" class="Avatarbutton" src="/Bilder/X.png">

                    <!--       <button type="submit" style="border: 0; background: transparent">
                    <img src="/images/Btn.PNG" width="90" height="50" alt="submit" />
                   </button> -->
                    <input id="loeschen" class="Avatarbutton" type="reset" name="bildloeschen" />
                </form>
            </div>
        </div>
